...
export class Storage implements att.ArchetypeType {
    ...
    static from_mich(input: att.Micheline): Storage {
        return new Storage(att.Address.from_mich((input as att.Mpair).args[0]), att.Address.from_mich((input as att.Mpair).args[1]), att.Address.from_mich((input as att.Mpair).args[2]), att.Int.from_mich((input as att.Mpair).args[3]), att.Int.from_mich((input as att.Mpair).args[4]), att.Int.from_mich((input as att.Mpair).args[5]), att.Int.from_mich((input as att.Mpair).args[6]), att.mich_to_bool((input as att.Mpair).args[7]), att.Option.from_mich((input as att.Mpair).args[8], x => { return att.Address.from_mich(x); }), att.Nat.from_mich((input as att.Mpair).args[9]), att.Int.from_mich((input as att.Mpair).args[10]), att.Int.from_mich((input as att.Mpair).args[11]));
    }
}
export class proxy_execute_param implements att.ArchetypeType {
    ...
    static from_mich(input: att.Micheline): proxy_execute_param {
        return new proxy_execute_param(mich_to_e_entrypoints((input as att.Mpair).args[0]), att.Address.from_mich((input as att.Mpair).args[1]), att.Bytes.from_mich((input as att.Mpair).args[2]), Storage.from_mich(att.pair_to_mich((input as att.Mpair as att.Mpair).args.slice(3, 15))));
    }
}
...
export class update_operator_param implements att.ArchetypeType {
    ...
    equals(v: update_operator_param): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): update_operator_param {
        return new update_operator_param((p => {
...
export class update_ledger_param implements att.ArchetypeType {
    ...
    equals(v: update_ledger_param): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): update_ledger_param {
        return new update_ledger_param((p => {
...
export const update_operator_param_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.pair_array_to_mich_type([
        att.prim_annot_to_mich_type("address", []),
        att.prim_annot_to_mich_type("nat", []),
        att.prim_annot_to_mich_type("address", [])
...
export const update_ledger_param_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.pair_array_to_mich_type([
        att.prim_annot_to_mich_type("address", []),
        att.prim_annot_to_mich_type("nat", [])
    ], ["%ulp_k"]),
